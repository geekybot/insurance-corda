 ...
 */
object UserRegistrationFLow {
    @InitiatingFlow
    @StartableByRPC
    class Initiator(val userName:String,
        ...
        override fun call(): SignedTransaction {
            ...
            val userState = UserState(getSaltString()+userName,userName,userAddress,owner,partner)
            val txCommand = Command(UserRegistrationContract.Commands.CreateUser(), listOf(owner.owningKey,partner.owningKey))
            val txBuilder = TransactionBuilder(notary)
                    .addOutputState(userState, UserRegistrationContract.ID)
