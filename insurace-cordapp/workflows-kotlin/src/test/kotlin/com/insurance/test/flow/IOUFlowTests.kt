package com.insurance.test.flow
...
//        listOf(a, b).forEach { it.registerInitiatedFlow(UserRegistrationFLow.Acceptor::class.java) }
//        network.runNetwork()
//    }
//
//    @After
...
//        val flow = UserRegistrationFLow.Initiator(-1, b.info.singleIdentity())
...
//        val iouValue = 1
//        val flow = UserRegistrationFLow.Initiator(iouValue, b.info.singleIdentity())
//        val future = a.startFlow(flow)
//        network.runNetwork()
//        val signedTx = future.getOrThrow()
//
