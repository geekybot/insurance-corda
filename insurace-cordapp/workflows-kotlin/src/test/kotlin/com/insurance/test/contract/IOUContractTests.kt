package com.insurance.test.contract
...
//                fails()
//                command(listOf(megaCorp.publicKey, miniCorp.publicKey), UserRegistrationContract.Commands.Create())
//                verifies()
//            }
//        }
//    }
...
//            transaction {
//                output(IOUContract.ID, IOUState(iouValue, miniCorp.party, megaCorp.party))
//                command(miniCorp.publicKey, UserRegistrationContract.Commands.Create())
...
//            transaction {
//                output(IOUContract.ID, IOUState(iouValue, miniCorp.party, megaCorp.party))
//                command(megaCorp.publicKey, UserRegistrationContract.Commands.Create())
//                `fails with`("All of the participants must be signers.")
//            }
//        }
//    }
